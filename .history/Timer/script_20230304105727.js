...
function displayComebackTime(seconds) {
    const comebackTime = new Date(Date.now() + seconds * 1000);
    const comebackHour = comebackTime.getHours();
    const comebackMinutes = comebackTime.getMinutes();
    console.log(comebackHour, comebackMinutes);
}
